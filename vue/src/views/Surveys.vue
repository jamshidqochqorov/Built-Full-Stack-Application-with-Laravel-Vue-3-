        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
            ...
            class="flex flex-col py-4 px-6 shadow-md bg-white hover:bg-gray-50 h-[470px]">
              <img :src="survey.image_url" class="w-full h-48 object-cover">
                <h4 class="mt-4 text-lg font-blade">{{survey.title}}</h4>
                ...
                <div class="flex justify-between items-center mt-3">
                    ...
                    class="h-8 w-8 items-center justify-center rounded-full border border-transparent text-sm text-red-500 fucus:ring-2 focus:ring-offset-2 focus:rind-red-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
function deleteSurvey(survey){
    if(confirm('Are you sure your want to delete thir survey?')){
